...
def get_args():
    ...
    parser.add_argument("--dest",
                        dest="destination",
                        default="output",
                        help="Destination directory for predictions. Will default to the directory 'output'")
...
def main(XML_path, journal_ids_path, word_indicies_path, group_thresh, journal_drop, destination):
    """
...
if __name__ == "__main__":
    ...
    main(args.path, journal_ids_path, word_indices_path, args.group_thresh, args.journal_drop, args.destination)
